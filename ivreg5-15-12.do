...
ren AN1 important
ren BN4 size
ren AN2 important_cotton 
*log using IV, replace text
foreach var of varlist size important important_cotton per_growers per_trained per_mutual {
	gen `var'xt=`var'*t
...
************************************************************
*COMPARE SNI GUYS WHO GOT AND DIDN'T GET GAMES
...
reg yield  t SNI SNIxt  TRAINING TRxt Info Infoxt , robust cluster(villcode)

reg yield  t SNI SNIxt  TRAINING TRxt Info Infoxt dummy400xSNI sex, robust cluster(villcode)
